...
public class EmployerMainView extends javax.swing.JFrame {
    ...
    IssueNotification objIssueNotification = objNotificationController.new IssueNotification();
    ...
    public EmployerMainView(UserContext userContext) {
        ...
        PopulateCompletedAllissuesEmployerList(userContext.getID());
...
//        System.out.println(list2);
    ...
    private void PopulateCompletedAllissuesEmployerList(String Id) {
        // load data from database
        list4 = objEmployerController.GetCompletedAllissuesEmployer(Id);
...
//        System.out.println(list2);
    ...
    private void initComponents() {
        ...
        typecommentsubmit = new javax.swing.JTextArea();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtStudentname1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(5, 5, 5))
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(5, 5, 5)
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/save button 30.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/comments icon 24.png"))); // NOI18N
        ...
        typecommentsubmit.setColumns(20);
        typecommentsubmit.setRows(5);
        jScrollPane1.setViewportView(typecommentsubmit);
        ...
        tab2Layout.setHorizontalGroup(
            ...
            .addGroup(tab2Layout.createSequentialGroup()
                .addGroup(tab2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(tab2Layout.createSequentialGroup()
                        .addGap(106, 106, 106)
                        .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, 669, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(46, 46, 46)
        ...
        tabalemanagecourses.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        ...
        helptEmployer.setEditable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int response = JOptionPane.showConfirmDialog(this, "Do you want to Comment this Issue ?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        if (response == 0) {
            ;
            String email = txtStudentemail1.getText();
            String stuID = txtStudentID1.getText();
            String name = txtStudentname1.getText();
            String comment = typecommentsubmit.getText();
            String type =txtissuetype1.getText();
            int issueid1 = Integer.parseInt(txtissueID1.getText());
            String ID=txtissueID1.getText();
            ...
            boolean result = objEmployerController.submitemyissueEmployer(objmyissuesEmployer);

            objIssueNotification.EmployerNotification(email, stuID, name, type, comment);  //this is the mehtod to call employer email
            
            PopulatemyAllissuesEmployerList(lblEMID.getText());
            PopulateAllissuesEmployerList();
            PopulateCompletedAllissuesEmployerList(lblEMID.getText());
...
//        System.out.println(list);
    ...
    private javax.swing.JTextArea typecommentsubmit;
