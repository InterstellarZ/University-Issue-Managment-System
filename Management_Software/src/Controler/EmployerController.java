...
//-------------------------------------------------------------------------------------------------------------------
    ...
    public List<Employer.AllissuesEmployer> GetCompletedAllissuesAdmin(String searchText) {
        List<Employer.AllissuesEmployer> result = deshan.GetCompletedAllissuesAdmin(searchText);
  ...
  //------------------------------------------------------------------------------------------------------------------
    ...
    public boolean submitemyissueEmployer(Employer.myissuesEmployer objMyissues) {
        boolean result = deshan.submitmyAllissuesEmployerTODB(objMyissues);
        return result;
    }
